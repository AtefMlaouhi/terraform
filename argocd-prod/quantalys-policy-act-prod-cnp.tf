module "policy-act-cnp-prod-init-namespace" {
...
resource "kubernetes_config_map_v1" "policy-act-cnp-prod-configmap-api-routes" {
  metadata {
    name      = "api-routes"
  ...
  data = {
    ...
    quantalys-investment-proxy-api        = "http://investment-proxy-api.policy-act-cnp-prod.svc.cluster.local"
    quantalys-policy-act-api              = "http://policy-act-api.policy-act-cnp-prod.svc.cluster.local"
    quantalys-policy-act-bff-api          = "http://policy-act-bff-api.policy-act-cnp-prod.svc.cluster.local"
    quantalys-policy-act-policyholder-api = "http://policy-act-policyholder-api.policy-act-cnp-prod.svc.cluster.local"
    quantalys-user-proxy-api              = "http://user-proxy-api.policy-act-cnp-prod.svc.cluster.local"
...
resource "kubernetes_config_map_v1" "policy-act-cnp-prod-configmap-instrumentation" {
  metadata {
...
resource "kubernetes_config_map_v1" "policy-act-cnp-prod-configmap-keycloak" {
  metadata {
    name      = "keycloak"
    namespace = "policy-act-cnp-prod"
  }
...
resource "kubernetes_secret_v1" "policy-act-cnp-prod-secret-keycloak" {
  metadata {
    name      = "keycloak"
    namespace = "policy-act-cnp-prod"
  }
...
module "policy-act-cnp-prod-quantalys-user-proxy-api" {
  source = "git::ssh://git@git.harvest.fr:10022/quantalys/cicd/terraform-argocd-gitlab.git//modules/argocd-project-app?ref=v5.3.0"
  project = {
    name = "policyact"
  }
  ...
  depends_on = [
    module.policy-act-cnp-prod-init-namespace,
    kubernetes_config_map_v1.policy-act-cnp-prod-configmap-instrumentation,
    kubernetes_config_map_v1.policy-act-cnp-prod-configmap-keycloak,
    kubernetes_secret_v1.policy-act-cnp-prod-secret-keycloak
  ]
  app = {
...
module "policy-act-cnp-prod-quantalys-policy-act-bff-api" {
  source = "git::ssh://git@git.harvest.fr:10022/quantalys/cicd/terraform-argocd-gitlab.git//modules/argocd-project-app?ref=v5.3.0"
  project = {
    name = "policyact"
  }
  ...
  depends_on = [
    module.policy-act-cnp-prod-init-namespace,
    kubernetes_config_map_v1.policy-act-cnp-prod-configmap-api-routes,
    kubernetes_config_map_v1.policy-act-cnp-prod-configmap-instrumentation,
    kubernetes_config_map_v1.policy-act-cnp-prod-configmap-keycloak,
    kubernetes_secret_v1.policy-act-cnp-prod-secret-keycloak
  ]
...
module "policy-act-cnp-prod-quantalys-policy-act-api" {
  source = "git::ssh://git@git.harvest.fr:10022/quantalys/cicd/terraform-argocd-gitlab.git//modules/argocd-project-app?ref=v5.3.0"
  project = {
    name = "policyact"
  }
...
module "policy-act-cnp-prod-quantalys-policy-frontend-shell" {
  source = "git::ssh://git@git.harvest.fr:10022/quantalys/cicd/terraform-argocd-gitlab.git//modules/argocd-project-app?ref=v5.3.0"
  project = {
    name = "policyact"
  }
...
module "policy-act-cnp-prod-quantalys-policy-frontend-shift-mfe" {
  source = "git::ssh://git@git.harvest.fr:10022/quantalys/cicd/terraform-argocd-gitlab.git//modules/argocd-project-app?ref=v5.3.0"
  project = {
    name = "policyact"
  }
