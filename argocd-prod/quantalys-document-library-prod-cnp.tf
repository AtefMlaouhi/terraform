...
resource "kubernetes_config_map_v1" "documment-library-cnp-prod-configmap-api-routes" {
  metadata {
    name      = "api-routes"
  ...
  data = {
    ...
    quantalys-document-library-api = "http://document-library-api.documentlibrary-cnp-prod.svc.cluster.local"
